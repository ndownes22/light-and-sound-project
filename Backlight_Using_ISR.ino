...
void PatientSelect(){
  // For Joe:
  // Rules of ISRs in Arduino C:
  // cannot return anything, cannot have any inputs
  // can only modify global, volatile variables
  // cannot call any functions that use interrupts
    // i.e., cannot use Serial, and likely cannot use most other 
